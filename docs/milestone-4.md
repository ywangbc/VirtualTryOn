...
- Until a still is ready, a saved look shows the look photo
...
A saved look on a catalog garment shows the look photo until the try-on still is ready, then the still. A new CSV garment can use the same path.
